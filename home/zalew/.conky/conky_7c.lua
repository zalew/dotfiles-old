...
function conky_main_box()
    ...
    local boxes_settings={
        ...
        {x=0,y=0,w=240,h=750, colour= { {0,0xFFFFFF,1}, {1,0x3D3D3D,1} }, radial_gradient= {100,0,50,100,0,740},
        corners = { {"circle",40} },},
        {x=10,y=22,w=220,h=720, colour= { {0,0xFFFFFF,1}, {1,0x3D3D3D,1} }, radial_gradient= {90,740,25,90,180,690},
        corners = { {"circle",30} },}, 
        {x=13,y=23,w=214,h=714, colour= { {0,0xC2C2C2,1}, {0.0,0x000000,1}, {1,0x5C5C5C,1} }, radial_gradient= {87,740,25,87,180,720},
        corners = { {"circle",27} },},
        {x=13,y=23,w=214,h=714, colour= { {0,0xFFFFFF,0.2}, {1,0xFFFFFF,0} }, linear_gradient= {57,0,57,654},
        corners = { {"circle",27} },scale_y=0.5},
